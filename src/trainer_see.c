...
static const struct SpriteFrameImage sSpriteImageTable_ExclamationQuestionMark[] =
{
    ...
    {
        .data = sEmotion_IdeaGfx,
        .size = sizeof(sEmotion_IdeaGfx)
    },
    {
        .data = sEmotion_XdGfx,
...
static const union AnimCmd sSpriteAnim_Icons6[] =
{
    ANIMCMD_FRAME(5, 60),
    ANIMCMD_END
};

static const union AnimCmd sSpriteAnim_Icons7[] =
{
    ANIMCMD_FRAME(6, 60),
    ANIMCMD_END
};

static const union AnimCmd sSpriteAnim_Icons8[] =
{
    ANIMCMD_FRAME(7, 60),
    ANIMCMD_END
};

static const union AnimCmd sSpriteAnim_Icons9[] =
{
    ANIMCMD_FRAME(8, 60),
    ANIMCMD_END
};
...
static const union AnimCmd sSpriteAnim_Icons16[] =
{
    ANIMCMD_FRAME(15, 60),
    ANIMCMD_END
};

static const union AnimCmd sSpriteAnim_Icons17[] =
{
    ANIMCMD_FRAME(16, 60),
    ANIMCMD_END
};
